...
# -*- coding: utf-8 -*-
"""
Created on Tue May 30 18:01:53 2017
...
#ones = dataset[dataset['DEFAULT PAYMENT JAN'] == 1]
#ones.info()
...
dataset['EDUCATION'] = dataset['EDUCATION'].replace(to_replace = 'other', value = 'university')
...
dataset['MARRIAGE'] = dataset['MARRIAGE'].replace(to_replace = 'other', value = 'married')
